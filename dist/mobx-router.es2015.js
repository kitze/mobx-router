          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                currentParams = toJS(this.params);
                currentQueryParams = toJS(this.queryParams);
              ...
              case 19:
                ...
                runInAction('update router state after async beforeExit and beforeEnter', function () {
                  _this.currentView = view;
                  _this.params = toJS(paramsObj);
                  _this.queryParams = toJS(queryParamsObj);
                });

                nextParams = toJS(paramsObj);
                nextQueryParams = toJS(queryParamsObj);
